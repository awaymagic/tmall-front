    ...
    <div class="wrapper">
      <div class="container clearfix">
        ...
        <div class="content">
          ...
          <div class="item-version clearfix">
            <h2>领取优惠券</h2>
            <div class="phone fl" v-for="(coupon ,index ) of coupons" :key="index"
              :class="{'checked':couponClicked==index}"
              @click="handlerCoupon(coupon.id,index)" >
          ...
          <div class="btn-group">
            <a href="javascript:;" class="btn btn-large fl" @click="addCoupon">领取优惠券</a>
...
export default{
  ...
  methods:{
    ...
    getCouponInfo(){
      this.axios.get(`/pms/getCoupons/${this.id}`).then((res)=>{
        this.coupons = res;
      })
    },
    addCoupon(){
      if(this.couponId==null || this.couponId==""){
        this.$message.warning('请选择一个可用的优惠券');
        return;
      }
      this.axios.post('/cart/addCoupon',{
    ...
    handlerCoupon(couponId,index){
      this.couponClicked = index;
